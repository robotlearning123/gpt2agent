...
- `gpt2agent/server.py` — SSE-backed MCP tool registration and stdio-only transport guard
...
- Version 0.0.12 is stdio-only. The legacy HTTP flag fails before server construction.
