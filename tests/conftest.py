...
# The task-queue worker must not spawn in tests — TaskQueue mechanics are
# exercised in tests/test_taskqueue.py against a tmp dir.
os.environ.setdefault("GPT2AGENT_QUEUE_OFF", "1")
